  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="(address, index) of addressInfo"
        :key="index"
      >
        ...
        <p @click="changeDefault(address, addressInfo)">
          ...
          <span :class="{ s3: address.isDefault == 1 }">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="order of orderInfo.detailArrayList"
          :key="order.skuId"
        >
          <li>
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      const params = {
        ...
        consigneeTel: this.addressInfo.phoneNum,
        deliveryAddress: this.addressInfo.fullAddress,
        paymentWay: "ONLINE",
        orderComment: this.msg,
        orderDetailList: this.orderInfo.detailArrayList,
      };
      const { data: res } = await this.$API.reqSubmitOrder(tradeNO, params);
      if (res.code == 200) {
