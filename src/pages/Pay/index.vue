  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" href="/paysuccess" @click="open">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    async getPayInfo() {
      const { data: res } = this.$API.reqPayInfo(this.orderId);
      if (res.code == 200) {
    ...
    async open() {
      ...
      this.$alert(`<img src=${result} />`, "请你微信支付", {
