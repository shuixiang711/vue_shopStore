        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前咱们的路由跳转：从A到B，加入购物车在路由跳转之前，我们要发送请求把购买的产品信息通过请求形式通知服务器，服务器再进行相应的存储 -->
...
export default {
  ...
  methods: {
    ...
    async addShopCar() {
      ...
      try {
        //成功
        await reqAddUpdateShopCart(this.$route.params.skuid, this.skuNum);
        //进行路由跳转
        //一些简单的数据，通过query形式给路由组件传递过去，而产品信息这些复杂的数据，则通过会话存储
